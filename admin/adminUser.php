    ...
    <table id="table">
        ...
        <!-- Pour chaque lignes du tableau $data : -->
            ...
            <tr>
                     ...
                     <td> <form action="../db/update.php" Method="POST"><input class="button" type="submit" value="Update"></form></td>
                     <td colspan=2><form action="../db/delete.php" Method="POST"><input class="button" type="submit" value="Delete"></form></td>
            </tr>
                <?php
                }
                ?>
